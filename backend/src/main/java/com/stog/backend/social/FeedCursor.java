...
record FeedCursor(Instant createdAt, long photoId) {
    private static final String VERSION = "v1";

    static FeedCursor decode(String value) {
        ...
        try {
            ...
            return new FeedCursor(Instant.ofEpochSecond(seconds, nanos), photoId);
    ...
    private static ResponseStatusException invalid() {
        return new ResponseStatusException(HttpStatus.BAD_REQUEST, "Feed cursor is invalid");
    }
}
